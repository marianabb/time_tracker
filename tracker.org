...
** TODO Meeting with Robin [2012-04-23 Mon]:
Three main thing we need to do now (already in the TODO, but we defined an order):
1. [ ] Learn ITK + write a program callable from Slicer.
...
*** TODO Write a simple ITK program that can be called from Slicer
