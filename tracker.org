...
** Skeleton
   ...
   2. Methods
      2.1. Registration
      2.1.1. Affine registration
      2.1.2. BSpline registration
      2.1.3. BRAINS Demon warp registration 
      2.2. Morphometry
      2.2.1. Voxel-based morphometry
      2.2.2. Tensor-based morphometry
      2.2.3. Deformation-based morphometry (Maybe)
   3. Proposed solutions
      ...
      3.4. Comparison to other methods (which? think about this)
   4. Experiments
      4.1. Voxel-based results
      4.2. Tensor-based results
