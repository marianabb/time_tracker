...
- [ ] Fix the volumes that we have. Make a list of what we have/need.
...
- [2012-04-11 Wed]: Meeting with Raili. 
...
*** TODO User selected threshold
*** TODO If registration method + registeredVolumeID changes -> subtractedVolumeID must be reset.
