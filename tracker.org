...
** TODO Meeting with Robin [2012-07-31 Tue]
   ...
   - [ ] Wrap up Tensor-based method. Jacobiant matrix or Jacobian determinant? Registration after smoothing?
** TODO Meeting with Robin [2012-08-27 Mon]
   - [ ] Plan and do the experiments.
     ...
     - Tensor based method can have a few changeable variables:
       - Displacement field smoothing sigma.
       - Percentage of the Jacobian to use (20%, 30%).
   - [ ] Apply log to the Jacobian before extracting the percentage to use.
   - [ ] Try FEMRegistration but only if it works fast.

** TODO Meeting with Raili and Robin [2012-08-28 Tue]
   - Suggestions for the experiments.
   - [ ] Prepare a few GOOD images for the paper. Focus on the patients CL and PB.
...
** Experiments
- MRIs with no changes
- Small added changes (darker spots)
  - 
